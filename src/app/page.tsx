    ...
    <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
      ...
      <section className="container" style={{ padding: "4rem 1.5rem", textAlign: "center" }}>
        <h1 style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)", letterSpacing: "-1.5px", marginBottom: "1rem" }}>
          ...
          <span className="gradient-accent" style={{ fontWeight: 800 }}>Inteligente & Sin Fricción</span>
        </h1>
        ...
        <div className="grid-auto" style={{ marginTop: "2rem" }}>
          ...
          <div className="glass-panel glow-effect" style={{ padding: "2rem", textAlign: "left", display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "var(--primary-glow)", color: "var(--primary)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5rem" }}>
              🏢
            </div>
          ...
          {/* Card 2: Freelancers */}
          <div className="glass-panel glow-effect" style={{ padding: "2rem", textAlign: "left", display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "rgba(245, 158, 11, 0.1)", color: "var(--accent)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5rem" }}>
              💼
            </div>
          ...
          {/* Card 3: Tenderos */}
          <div className="glass-panel glow-effect" style={{ padding: "2rem", textAlign: "left", display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "var(--secondary-glow)", color: "var(--secondary)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5rem" }}>
              🛒
            </div>
      ...
      <section className="container" style={{ marginBottom: "4rem" }}>
        <div className="glass-panel" style={{ padding: "2rem", display: "flex", flexDirection: "column", gap: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
          <h2 style={{ fontSize: "1.5rem" }}>⚙️ Arquitectura de la Solución</h2>
